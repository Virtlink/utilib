...
namespace Virtlink.Utilib.Text
{
    ...
    {
        /// <summary>
        /// Tests the <see cref="CodePoint.IsSurrogatePair"/> property.
        /// </summary>
        public sealed class IsSurrogatePairTests
        {
            public static IEnumerable<object[]> Valid => new List<object[]>
            {
                new object[] { new CodePoint(0x110D5) },    // SORA SOMPENG LETTER GAH [Lo]
                new object[] { new CodePoint(0x12121) },    // CUNEIFORM SIGN GUD OVER GUD LUGAL [Lo]
                new object[] { new CodePoint(0x13026) },    // EGYPTIAN HIEROGLYPH A033 [Lo]
                new object[] { new CodePoint(0x1F031) },    // DOMINO TILE HORIZONTAL-00-00 [So]
                new object[] { new CodePoint(0x1F197) },    // SQUARED OK [So]
                new object[] { new CodePoint(0x1F315) },    // FULL MOON SYMBOL [So]
            };

            [Theory]
            [MemberData(nameof(Valid))]
            public void ShouldReturnTrue_WhenCodepointIsSurrogatePair(CodePoint codepoint)
            {
                // Act
                var result = codepoint.IsSurrogatePair;
            ...
            public void ShouldReturnFalse_WhenCodepointNotIsSurrogatePair(CodePoint codepoint)
            {
                // Act
                var result = codepoint.IsSurrogatePair;
            ...
            public void ShouldReturnFalse_WhenCodePointIsEof()
            {
                ...
                // Act
                var result = instance.IsSurrogatePair;
