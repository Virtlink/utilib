...
namespace Virtlink.Utilib.Text
{
    ...
    {
        /// <summary>
        /// Tests the <see cref="CodePoint.IsSeparator"/> property.
        /// </summary>
        public sealed class IsSeparatorTests
        {
            ...
            public void ShouldReturnTrue_WhenCodepointIsSeparator(CodePoint codepoint)
            {
                // Act
                var result = codepoint.IsSeparator;
            ...
            public void ShouldReturnFalse_WhenCodepointNotIsSeparator(CodePoint codepoint)
            {
                // Act
                var result = codepoint.IsSeparator;
            ...
            public void ShouldReturnFalse_WhenCodePointIsEof()
            {
                ...
                // Act
                var result = instance.IsSeparator;
