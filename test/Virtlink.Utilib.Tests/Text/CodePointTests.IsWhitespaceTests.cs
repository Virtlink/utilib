...
namespace Virtlink.Utilib.Text
{
    ...
    {
        /// <summary>
        /// Tests the <see cref="CodePoint.IsWhitespace"/> property.
        /// </summary>
        public sealed class IsWhitespaceTests
        {
            ...
            public void ShouldReturnTrue_WhenCodepointIsWhitespace(CodePoint codepoint)
            {
                // Act
            ...
            public void ShouldReturnFalse_WhenCodePointIsEof()
            {
                ...
                // Act
                var result = instance.IsWhitespace;
