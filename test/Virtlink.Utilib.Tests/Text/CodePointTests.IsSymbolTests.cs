...
namespace Virtlink.Utilib.Text
{
    ...
    {
        /// <summary>
        /// Tests the <see cref="CodePoint.IsSymbol"/> property.
        /// </summary>
        public sealed class IsSymbolTests
        {
            ...
            public void ShouldReturnTrue_WhenCodepointIsSymbol(CodePoint codepoint)
            {
                // Act
                var result = codepoint.IsSymbol;
            ...
            public void ShouldReturnFalse_WhenCodepointNotIsSymbol(CodePoint codepoint)
            {
                // Act
                var result = codepoint.IsSymbol;
