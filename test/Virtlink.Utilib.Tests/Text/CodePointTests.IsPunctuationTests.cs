...
namespace Virtlink.Utilib.Text
{
    ...
    {
        /// <summary>
        /// Tests the <see cref="CodePoint.IsPunctuation"/> property.
        /// </summary>
        public sealed class IsPunctuationTests
        {
            ...
            public void ShouldReturnTrue_WhenCodepointIsPunctuation(CodePoint codepoint)
            {
                // Act
            ...
            public void ShouldReturnFalse_WhenCodePointIsEof()
            {
                ...
                // Act
                var result = instance.IsPunctuation;
