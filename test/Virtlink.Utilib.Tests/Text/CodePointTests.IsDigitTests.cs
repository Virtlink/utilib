...
namespace Virtlink.Utilib.Text
{
    ...
    {
        /// <summary>
        /// Tests the <see cref="CodePoint.IsDigit"/> property.
        /// </summary>
        public sealed class IsDigitTests
        {
            ...
            public void ShouldReturnTrue_WhenCodepointIsDigit(CodePoint codepoint)
            {
                // Act
                var result = codepoint.IsDigit;
            ...
            public void ShouldReturnFalse_WhenCodepointNotIsDigit(CodePoint codepoint)
            {
                // Act
                var result = codepoint.IsDigit;
