...
namespace Virtlink.Utilib.Text
{
    ...
    {
        /// <summary>
        /// Tests the <see cref="CodePoint.IsNumber"/> property.
        /// </summary>
        public sealed class IsNumberTests
        {
            ...
            public void ShouldReturnTrue_WhenCodepointIsNumber(CodePoint codepoint)
            {
                // Act
                var result = codepoint.IsNumber;
            ...
            public void ShouldReturnFalse_WhenCodepointNotIsNumber(CodePoint codepoint)
            {
                // Act
                var result = codepoint.IsNumber;
