...
namespace Virtlink.Utilib.Text
{
    ...
    {
        /// <summary>
        /// Tests the <see cref="CodePoint.IsLetterOrDigit"/> property.
        /// </summary>
        public sealed class IsLetterOrDigitTests
        {
            ...
            public void ShouldReturnTrue_WhenCodepointIsLetterOrDigit(CodePoint codepoint)
            {
                // Act
            ...
            public void ShouldReturnFalse_WhenCodePointIsEof()
            {
                ...
                // Act
                var result = instance.IsLetterOrDigit;
