...
namespace Virtlink.Utilib.Text
{
    ...
    {
        /// <summary>
        /// Tests the <see cref="CodePoint.IsLower"/> property.
        /// </summary>
        public sealed class IsLowerTests
        {
            ...
            public void ShouldReturnTrue_WhenCodepointIsLower(CodePoint codepoint)
            {
                // Act
                var result = codepoint.IsLower;
            ...
            public void ShouldReturnFalse_WhenCodepointNotIsLower(CodePoint codepoint)
            {
                // Act
                var result = codepoint.IsLower;
