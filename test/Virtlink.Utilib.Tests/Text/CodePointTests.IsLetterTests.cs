...
namespace Virtlink.Utilib.Text
{
    ...
    {
        /// <summary>
        /// Tests the <see cref="CodePoint.IsLetter"/> property.
        /// </summary>
        public sealed class IsLetterTests
        {
            ...
            public void ShouldReturnTrue_WhenCodepointIsLetter(CodePoint codepoint)
            {
                // Act
                var result = codepoint.IsLetter;
            ...
            public void ShouldReturnFalse_WhenCodepointNotIsLetter(CodePoint codepoint)
            {
                // Act
                var result = codepoint.IsLetter;
