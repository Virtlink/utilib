...
{
	/// <summary>
	/// Encodes data as 2's complement least-significant byte first.
	/// </summary>
	public class LittleEndianDataEncoding : DataEncoding
	{
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="LittleEndianDataEncoding"/> class.
		/// </summary>
		public LittleEndianDataEncoding()
			: base()
		{
